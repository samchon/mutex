...
export class ProviderGroup
{
    ...
    public constructor(group: GlobalGroup, acceptor: WebAcceptor<any, any>)
    {
        ...
        this.condition_variables = new ConditionVariablesProvider(group.condition_variables, acceptor, this.disolvers_, "RemoteConditionVariable");
        this.mutexes = new MutexesProvider(group.mutexes, acceptor, this.disolvers_, "RemoteMutex");
        this.semaphores = new SemaphoresProvider(group.semaphores, acceptor, this.disolvers_, "RemoteSemaphore");

        this.barriers = new BarriersProvider(group.barriers, acceptor, this.disolvers_, "RemoteBarrier");
        this.latches = new LatchesProvider(group.latches, acceptor, this.disolvers_, "RemoteLatch");
    }
