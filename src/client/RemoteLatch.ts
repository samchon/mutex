 ...
 * Howver, unlike {@link RemoteBarrier} who can reusable that downward counter be reset whenever 
 * reach to the zero, downward of the `RemoteLatch` is not reusable but diposable.
 * 
...
export class RemoteLatch
{
     ...
     * 
     * If the {@link RemoteLatch} already has been reached to the zero, it would be returned 
     * immediately.
     */
     ...
     * returns `true`. Otherwise, the {@link RemoteLatch} fails to reach to the zero in the 
